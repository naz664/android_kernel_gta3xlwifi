#ifndef FIMC_IS_EEPROM_REAR_3P8SP_IMX471_V001_H
#define FIMC_IS_EEPROM_REAR_3P8SP_IMX471_V001_H

//Universal EEPROM map data_V001_20181101_for_A30_M30_LassenO_3P8SP_Front.xlsx
//Universal EEPROM map data_V001_20181101_for_A30_M30_LassenO_IMX471_Front.xlsx
...
const struct rom_extend_cal_addr front_3p8sp_imx471_extend_cal_addr[COUNT_EXTEND_CAL_DATA] = {
	{"oem_checksum_base_addr", 0x0190},
};

const struct fimc_is_vender_rom_addr front_3p8sp_imx471_cal_addr = {
	/* Set '-1' if not used */
	...
	front_3p8sp_imx471_extend_cal_addr,			//void*			extended_cal_addr;
};


#endif /* FIMC_IS_EEPROM_REAR_3P8SP_IMX471_V001_H */
